    ...
    <>
      <main className="option-static-header min-h-screen overflow-x-hidden bg-[#f6f7f3] text-[#17211d]">
            ...
            <div className="grid min-w-0 grid-cols-1 gap-4 sm:grid-cols-2">
              {services.map((service) => (
                <Link
                  ...
                  className="group min-w-0 rounded-lg border border-[#d8ddd2] bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-[#bfc8b8] hover:shadow-md"
                >
                  ...
                  <span className="mt-5 inline-flex text-sm font-semibold text-[#8f3f2f] transition group-hover:text-[#17211d]">
                    View service
                  </span>
                </Link>
              ))}
            ...
            <ol className="grid min-w-0 gap-4">
              {process.map((step, index) => (
                ...
                >
                  ...
                  <p className="pt-1 text-lg leading-7 text-[#2f3d35]">
                    {step}
                  </p>
                </li>
              ))}
        ...
        <section id="contact" className="py-16">
          <div className="site-shell grid grid-cols-1 gap-8 border-t border-[#d8ddd2] pt-12 lg:grid-cols-[1fr_0.75fr]">
            <div className="min-w-0 max-w-[18.5rem] sm:max-w-none">
              <p className="text-sm font-semibold uppercase text-[#8f3f2f]">
                Contact
              </p>
